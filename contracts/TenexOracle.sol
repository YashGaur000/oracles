...
import "../interfaces/ITenexPair.sol";
import {IERC20Metadata} from "@openzeppelin/contracts/token/ERC20/extensions/IERC20Metadata.sol";
import "../libraries/Sqrt.sol";
import "../libraries/Address.sol";
import {Clones} from "@openzeppelin/contracts/proxy/Clones.sol";
import {IPoolFactory} from "../interfaces/IPoolFactory.sol";
import {ITenexOracle} from "../interfaces/ITenexOracle.sol";
...
contract TenexOracle is ITenexOracle {
    ...
    /// @param _factoryV2 Address of the factory contract for Tenex pairs
    ...
    function _stableRate(IERC20Metadata t0, IERC20Metadata t1, int256 dec_diff) internal view returns (uint256 rate) {
        ...
        // newOut in t1
        try ITenexPair(currentPair).getAmountOut((10 ** t0_dec), address(t0)) returns (uint256 result) {
            newOut = result;
        } catch {
            return 0;
        }
    ...
    /// @dev Codes from https://github.com/Tenexdrome-finance/contracts/blob/main/contracts/Router.sol#L102C7-L102C110
        ...
        returns (uint256 srcBalance, uint256 dstBalance)
    {
        ...
        if (!Address.isContract(pairAddress)) {
            ...
            (uint256 reserve0, uint256 reserve1,) = ITenexPair(pairAddress).getReserves();
